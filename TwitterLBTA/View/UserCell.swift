...
class UserCell: DatasourceCell {
    ...
    let bioTextView: UITextView = {
        ...
        textView.text = "iPhone, iPad, iOS Programming Community. Join us to learn Swift and build iOS apps!"
...
//        button.titleEdgeInsets
    ...
    override func setupViews() {
        ...
        usernameLabel.anchor(nameLabel.bottomAnchor, left: nameLabel.leftAnchor, bottom: nil, right: followButton.leftAnchor, topConstant: 4, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: 20)
